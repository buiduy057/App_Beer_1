  ...
  <div class="grid">
    ...
    <form action="" method="POST" class="form login">
      ...
      <div class="form__field">
        <label><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">name</span></label>
        <input  type="text" name="name" class="form__input" placeholder="Username" required>
      </div>
